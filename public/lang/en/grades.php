...
$string['eventscalelocked'] = 'Scale locked';
...
$string['scaleconfirmlock'] = 'Are you sure you wish to lock the scale "{$a}"? It could then not be used for new activities or competencies.';
